...
object TagSerializer : KSerializer<Tag> {
    override val descriptor: SerialDescriptor = PrimitiveSerialDescriptor("Tag", PrimitiveKind.INT)

    private val map = Tag.values().associateBy { it.id }

    override fun deserialize(decoder: Decoder): Tag {
        val id = decoder.decodeInt()
        return map[id] ?: Tag.Transfer
    }
