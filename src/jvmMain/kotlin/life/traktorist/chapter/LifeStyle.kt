...
private val internet = FaqItem(
    ...
    answer = listOf(
        ...
        "Приём стабильный, скорость интернета хорошая (но в разгар сезона мобильный интернет может очень сильно проседать по скорости), но в сильный дождь могут быть проблемы.".paragraph(),
        ...
        "Стоимость".header(),
        "Сильно зависит от выбранного тарифа/пакета. Проводной интернет в среднем от 20-25 евро в месяц, мобильный от 10-15 евро в месяц, пакеты проводной+мобильный+телевидение+домашний телефон - от 40 евро в месяц. Можно посмотреть тарифы на сайтах mtel.me и telekom.me.".paragraph(),
        "Для интернет-звонков и конференций хватит?".header(),
...
private val relationToRussians = FaqItem(
    ...
    answer = listOf(
        "Отношение у местных хорошее, происходящие события не привели к изменению отношения по национальному признаку.".paragraph(),
        "Большой приток постоянно живущих иностранцев (плюсом в 2023-2024 приехало много переселенцев из Турции) начинает вызывать недовольство, т.к. растёт нагрузка на медицину, школы и пр. На август 2025 серьёзных изменений законодательства пока не принято, но в обсуждении присутствует ряд пунктов, приводящих к существенному сокращению возможности иностранцам постоянно проживать на территории страны.".paragraph(),
    ),
    listOf(Tag.LifeStyle),
    null
)
...
private val lifeCost = FaqItem(
    ...
    answer = listOf(
        ...
        "Стоимость продуктов питания до февраля 2022 была сравнима с российскими магазинами среднего класса, но с пересчётом в евро по курсу 80р. Т.е. если условные яблоки стоили 60 рублей за килограмм, то в Черногории они стоят 75 евроцентов за кило. Есть и дороже и дешевле, конечно, но в среднем можно прикинуть.".paragraph(),
        ...
        "Довольно много фастфуда, причём локального, а Макдоналдс и KFC вы не встретите (BurgerKing есть, но ценник/объём вряд ли вас порадует). Есть пицца, бургеры, мясо в пите, всевозможные виды мяса на гриле. По порциям аналогично, бургер будет граммов на 300, с большим курсом мяса или котлетой. Стоимость 4-8евро в среднем за бургеры/мясо в пите.".paragraph(),
        "Техника".header(),
        "В столице компьютерная техника примерно на 50% дороже, чем в интернет-магазине computer universe. В Будве - уже в два раза (при том что билет автобус Будва-Подгорица 7-8 евро в одну сторону).".paragraph(),
        "Плюс, если вы оплачиваете наличными, некоторые магазины готовы предоставить вам неплохую скидку.".paragraph(),
        "Китайские магазины".header(),
        ...
        "Есть возможность заказывать на Temu (аналог AliExpress). Цену за доставку не увеличивают, по Черногории в основном доставляется местными курьерскими службами. Средний срок доставки 2-3 недели.".paragraph(),
    ),
    listOf(Tag.LifeStyle),
    listOf(Tag.Finance)
)
