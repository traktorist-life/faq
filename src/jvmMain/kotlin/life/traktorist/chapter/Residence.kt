...
private val spravkaNesudimost = FaqItem(
    ...
    answer = listOf(
        ...
        "Справку можно заказать и забрать в консульстве РФ (необходима предварительная регистрация <a href='https://montenegro.mid.ru/spr_sudimost'>на посещение консульства</a>), причём очереди в соседних странах были меньше и можно было обращаться туда. Сейчас людей сильно больше, чем возможности консульства, и все слоты времени приёма граждан на 3 месяца вперёд заняты.".paragraph(),
...
private val permanentResidence = FaqItem(
    ...
    answer = listOf(
        ...
        "- некоторые банки не оказывают услуги по ВНЖ, но оказывают по ПМЖ (по отзывам есть и те, что вообще оказывают услуги только гражданам страны)".paragraph(),
