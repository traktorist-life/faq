...
private val permanentResidence = FaqItem(
    ...
    answer = listOf(
        ...
        "- существенно ниже налог на недвижимость".paragraph(),
...
private val moneyForBoravak = FaqItem(
    question = "Сумма на счету для оформления ВНЖ по недвижимости",
    answer = listOf(
        "Один из обязательных документов в пакете на ВНЖ - справка из банка о наличии необходимой суммы на счёте (см. вопрос по открытию счёта в финансах).".paragraph(),
